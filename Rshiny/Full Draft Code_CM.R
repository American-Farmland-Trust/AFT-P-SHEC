...
server <- function(input, output, session) {
  ...
  # Reactive function to get individual SOM changes for each practice
  get_som_change_details <- reactive({
    ...
    tillage_change <- selected_comet_data %>%
    ...
    nutrient_mgmt_change <- selected_comet_data %>%
    ...
    cover_cropping_change <- selected_comet_data %>%
