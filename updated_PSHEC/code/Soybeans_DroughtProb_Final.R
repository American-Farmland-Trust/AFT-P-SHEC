...
#Soybeans_DSCI_mean_county_by_year.rds base data
#Copy of original data
Soybeans<-SOYBEANS_DSCI_mean_county_by_year

#sort Soybeans by state_alpha, county, then year
Soybeans<-Soybeans %>%
...
# View results
print(Soybeans_results)


head(Soybeans_results)

Soybeans_results <- Soybeans_results %>%
