...
x <- split(gdb_list, ceiling(seq_along(gdb_list)/3)) # divide list to combine every 5 states
...
all_states_gssurgo <- parallel::mclapply(mc.cores = 8 , gdb_list, function(i){ #28
...
# Define the output directory
input_dir  <- "bulk_density/all_counties_gssurgo/"
temp_dir   <- "bulk_density/county_gssurgo_temp_chunks/"
