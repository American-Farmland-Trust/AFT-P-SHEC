...
# this file is for grouped crops
...
group_function <- function(LAR_name, ...) {
  ...
  # for very long file names 
  # Abbreviate each crop name to a specified minimum length (e.g., 3 letters)
  group_name <- paste(abbreviate(crop_name, minlength = 3), collapse = '_')
  ...
  cl <- makePSOCKcluster(parallel::detectCores()-6)  # Use defined number of core
